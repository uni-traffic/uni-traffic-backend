...
import { violationRecordRouter } from "../../../../../modules/violationRecord/src/infrastracture/http/router/violationRecordRouter";
...
v1Router.use("/violationRecord", violationRecordRouter);
